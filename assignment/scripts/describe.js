...
FIX - this console.log if age is greater than or equal to minAge is 'no entry' but it should be 'enter'. The other console.log in the else statement should be changed to 'no entry'.
if(minAge <= age) {
